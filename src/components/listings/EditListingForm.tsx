...
export function EditListingForm({ listing, isAdmin = false }: EditListingFormProps) {
  ...
  const {
    ...
    defaultValues: {
      ...
      location: listing.location as ListingFormData['location'],
      ageRange: listing.ageRange || '',
      brand: listing.brand || '',
      size: listing.size || '',
      adminNumber: listing.adminNumber || '',
      adminPlace: listing.adminPlace || '',
